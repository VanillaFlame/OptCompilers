...
### 3. Протяжка констант. Протяжка копий. <a name = "BBL_3"></a>
1. **Команда, реализующая задачу**
Чухин А. И., Агафонцев Р. Г.
2. **Зависимые и предшествующие задачи**
...
### 4. Оптимизация общих подвыражений <a name = "BBL_4"></a>
1. **Команда, реализующая задачу**
Османян В. А., Маслова О. В.
2. **Зависимые и предшествующие задачи**
...
### 6. Def, Use информация. <a name = "BBL_6"></a>
1. **Команда, реализующая задачу**
    Гуртовой А. И., Остапенко М. В.
...
### 7. Свертка констант в трехадресном коде <a name = "BBL_7"></a>
...
### 8. Устранение переходов к переходам. Удаление пустых операторов. <a name = "BBL_8"></a>
1. **Команда, реализующая задачу**
Манукян Г. А.
...
```
---
### Итерационные алгоритмы <a name = "Iter"></a>
...
#### Список задач <a name = "Iter_Tasks"></a>
...
### 1. Итерационный алгоритм в структуре распространения констант и передаточная функция. <a name = "Iter_1"></a>
...
### 2. Доступные выражения <a name = "Iter_2"></a>
1.  **Команда, реализующая задачу** 
Погорелов А. А., Домбровская А. В.
...
```
---
### 3. Разработка альтернативной реализации хранения IN и OUT в виде битовых векторов. Интеграция этого представления в итерационный алгоритм о достигающих определениях. <a name = "Iter_3"></a>
...
### 1. Построение дерева доминаторов <a name = "Loops_1"></a>
1. **Команда, реализующая задачу**
Гарьковенко А., Руднев. Д.
2. **Зависимые и предшествующие задачи**
...
### 2. Алгоритм упорядочения в глубину с построением глубинного остовного дерева. <a name = "Loops_2"></a>
1. **Команда, реализующая задачу**
Османян В. А., Маслова О. В.
2. **Зависимые и предшествующие задачи**
...
### 4. Обратные ребра и определение того, что CFG является приводимым <a name = "Loops_4"></a>
1. **Команда, реализующая задачу**
Чубинидзе Н. Р., Романченко Р. Д.
2. **Зависимые и предшествующие задачи**
...
```
---
### 5. Определение всех естесственных циклов <a name = "Loops_5"></a>
1. **Команда, реализующая задачу**
Погорелов А. А., Домбровская А. В.
