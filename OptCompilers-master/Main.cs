        ...
        public static void Main()
        {
            ...
            try
            {
                ...
                */
                ...
                //    Console.WriteLine(c.Label + ": \t" + c.Operation + '\t' + c.Argument1 + '\t' + c.Argument2 + '\t' + c.Result);
                //}
                var DeadAliveOptimize = new DeadAliveOptimize(TACGenerator.Instructions);
                DeadAliveOptimize.Run();

                foreach (var c in DeadAliveOptimize.Instructions)
                {
                    Console.WriteLine(c.Label + ": \t"  + c.Result + '\t' + c.Operation + '\t' + c.Argument1 + '\t' + c.Argument2 );
                }
            }
